...
pub fn build_factory() -> Rc<RefCell<Factory>> {
    ...
    .build(|factory| {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![BufferedInput::new(Filter::Label("Sugar Canes"), 2)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Thorium Ore"), 1, vec![0]),
                        SlottedInput::new(Filter::Label("Sand"), 1, vec![1]),
                    ],
                    max_per_slot: 8,
                },
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Uranium Ore"), 1, vec![0]),
                        SlottedInput::new(Filter::Label("Sand"), 1, vec![1]),
                    ],
                    max_per_slot: 8,
                },
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Fluxed Electrum Blend"), 1, vec![0]),
                        SlottedInput::new(Filter::Label("Sand"), 1, vec![1]),
                    ],
                    max_per_slot: 8,
                },
        ...
        factory.add_process(SlottedConfig {
            ...
            accesses: vec![BusAccess {
                client: "1a",
                inv_addr: "nuclearcraft:melter_2",
                bus_addr: "minecraft:ender chest_0",
            }],
            input_slots: vec![0],
            to_extract: None,
        ...
        factory.add_process(SlottedConfig {
            ...
            accesses: vec![BusAccess {
                client: "1a",
                inv_addr: "nuclearcraft:melter_4",
                bus_addr: "minecraft:ender chest_0",
            }],
            input_slots: vec![0],
            to_extract: None,
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![
                        ...
                        Output { item: green_congealed_slime_block(), n_wanted: 64 },
                    ],
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("End Essence"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("End Seeds"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            accesses: vec![BusAccess {
                client: "1a",
                inv_addr: "thermalexpansion:machine_charger_0",
                bus_addr: "minecraft:ender chest_0",
            }],
            input_slots: vec![0],
            to_extract: None,
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Nickel Plate"), n_wanted: 64 }],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![BufferedRecipe {
                ...
                inputs: vec![BufferedInput::new(Filter::Label("Birch Wood Planks"), 2)],
                max_inputs: 16,
            }],
            max_recipe_inputs: i32::MAX,
            stocks: vec![],
        ...
        factory.add_process(InputlessConfig {
            ...
            slot_filter: None,
            outputs: vec![Output { item: blue_congealed_slime_block(), n_wanted: 16 }],
        });
        factory.add_process(InputlessConfig {
            accesses: vec![BusAccess {
                client: "1a",
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    outputs: vec![
                        ...
                        Output { item: Filter::Label("Peridot"), n_wanted: 64 },
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Beryllium Dust"), n_wanted: 64 }],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Fluorite"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Peridot"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
            ...
            child: RedstoneConditionalConfig {
                ...
                child: SlottedConfig {
                    ...
                    recipes: vec![SlottedRecipe {
                        ...
                        inputs: vec![
                            SlottedInput::new(Filter::Label("Manasteel Ingot"), 1, vec![0]),
                            SlottedInput::new(Filter::Label("Mana Diamond"), 1, vec![1]),
                            SlottedInput::new(Filter::Label("Mana Pearl"), 1, vec![2]),
                        ],
                        max_per_slot: 1,
                    }],
                },
        ...
        factory.add_process(BufferedConfig {
            ...
            stocks: vec![
                ...
                BufferedInput::new(Filter::Label("Lithium Dust"), 64),
            ],
        });
        factory.add_process(SlottedConfig {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    ...
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Tin Ingot"), 5),
                        BufferedInput::new(Filter::Label("Redstone"), 2),
                    ],
                    max_inputs: 28,
                },
                BufferedRecipe {
                    ...
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Enori Crystal"), 4),
                        BufferedInput::new(Filter::Name("rftools:machine_frame"), 1),
                        BufferedInput::new(Filter::Label("Heavy Engineering Block"), 1),
                        BufferedInput::new(Filter::Label("Iron Casing"), 1),
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Name("minecraft:slime_ball"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(green_congealed_slime_block(), 1)],
                    max_inputs: 16,
                },
            ],
        });
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        SlottedInput::new(Filter::Label("Mana Diamond"), 1, vec![1]),
                        SlottedInput::new(Filter::Label("Manyullyn Ingot"), 1, vec![2]),
                        SlottedInput::new(Filter::Label("Zirconium Dust"), 1, vec![3]),
                ...
                SlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        SlottedInput::new(blue_congealed_slime_block(), 1, vec![4]),
                    ],
                    max_per_slot: 1,
                },
                SlottedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Diorite"), n_wanted: 64 }],
                    inputs: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Andesite"), n_wanted: 64 }],
                    inputs: vec![
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Empowered Emeradic Crystal"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Empowered Emeradic Crystal Block"), 1)],
                    max_inputs: 8,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Empowered Diamatine Crystal"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Empowered Diamatine Crystal Block"), 1)],
                    max_inputs: 8,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Empowered Palis Crystal"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Empowered Palis Crystal Block"), 1)],
                    max_inputs: 8,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Empowered Enori Crystal"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Empowered Enori Crystal Block"), 1)],
                    max_inputs: 8,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Bone"), n_wanted: 64 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Skeleton Essence"), 5)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            accesses: vec![BusAccess {
                client: "1a",
                inv_addr: "immersiveengineering:woodencrate_28",
                bus_addr: "minecraft:ender chest_0",
            }],
            input_slots: vec![0, 1, 2, 3, 4, 5, 6, 7],
            to_extract: None,
            recipes: vec![SlottedRecipe {
                outputs: vec![Output { item: Filter::Label("Elite Crafting Table"), n_wanted: 16 }],
                inputs: vec![
                    SlottedInput::new(Filter::Label("Hardened Cell Frame"), 4, vec![0]),
                    SlottedInput::new(Filter::Label("Elite Component"), 8, vec![1]),
                    SlottedInput::new(Filter::Label("Signalum Cell Frame (Full)"), 2, vec![2]),
                    SlottedInput::new(Filter::Label("Advanced Crafting Table"), 2, vec![3]),
                    SlottedInput::new(Filter::Label("Mana Dust"), 4, vec![4]),
                    SlottedInput::new(Filter::Label("Fluxed Phyto-Gro"), 2, vec![5]),
                    SlottedInput::new(Filter::Label("Osgloglas Block"), 2, vec![6]),
                    SlottedInput::new(Filter::Label("Crafter Tier 3"), 1, vec![7]),
                ],
                max_per_slot: 8,
            }],
        });
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Fiery Ingot"), n_wanted: 64 }],
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![BufferedInput::new(Filter::Label("End Essence"), 8)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            accesses: vec![BusAccess {
                client: "1a",
                inv_addr: "immersiveengineering:woodencrate_29",
                bus_addr: "minecraft:ender chest_0",
            }],
            slot_filter: None,
            to_extract: None,
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("1k ME Fluid Storage Component"), n_wanted: 4 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Logic Processor"), 1),
                        BufferedInput::new(Filter::Label("Lapis Lazuli"), 4),
                        BufferedInput::new(Filter::Label("Pure Certus Quartz Crystal"), 4),
                    ],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("4k ME Fluid Storage Component"), n_wanted: 4 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("1k ME Fluid Storage Component"), 3),
                        BufferedInput::new(Filter::Label("Calculation Processor"), 1),
                        BufferedInput::new(Filter::Label("Quartz Glass"), 1),
                        BufferedInput::new(Filter::Label("Lapis Lazuli"), 4),
                    ],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("16k ME Fluid Storage Component"), n_wanted: 4 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("4k ME Fluid Storage Component"), 3),
                        BufferedInput::new(Filter::Label("Calculation Processor"), 1),
                        BufferedInput::new(Filter::Label("Quartz Glass"), 1),
                        BufferedInput::new(Filter::Label("Lapis Lazuli"), 4),
                    ],
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("64k ME Fluid Storage Component"), n_wanted: 4 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("16k ME Fluid Storage Component"), 3),
                        BufferedInput::new(Filter::Label("Calculation Processor"), 1),
                        BufferedInput::new(Filter::Label("Quartz Glass"), 1),
                        BufferedInput::new(Filter::Label("Lapis Lazuli"), 4),
                    ],
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Nether Quartz Dust"), 5),
                        BufferedInput::new(Filter::Label("Glass"), 4),
                    ],
                    max_inputs: i32::MAX,
                },
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Item Buffer"), n_wanted: 16 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Electrical Steel Ingot"), 4),
                        BufferedInput::new(Filter::Label("Birch Chest"), 1),
                        BufferedInput::new(Filter::Label("Iron Ingot"), 4),
                    ],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Hopper"), n_wanted: 16 }],
                    inputs: vec![
                        BufferedInput::new(Filter::Label("Aluminum Plate"), 5),
                        BufferedInput::new(Filter::Label("Birch Chest"), 1),
                    ],
                    max_inputs: i32::MAX,
                },
