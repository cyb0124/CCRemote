...
use super::{access::*, item::*, lua_value::*, process::*, recipe::*, storage::*};
    ...
    */
    FactoryConfig {
        ...
        backups: vec![
            ...
            (Filter::Label("Mystical Red Flower"), 8),
    ...
    .build(|factory| {
        let air_canister = |full| {
            Filter::Fn(Box::new(move |_, detail| {
                detail.label == "Air Canister" && detail.others.get(&Key::from("durability")).is_none() == full
            }))
        };
        let luck_cleaver = |repaired| {
            Filter::Fn(Box::new(move |_, detail| {
                detail.label == "Luck Cleaver"
                    && detail
                        .others
                        .get(&Key::from("damage"))
                        .and_then(|x| i32::try_from(x.clone()).ok())
                        .map_or(false, |x| (x < 200) == repaired)
            }))
        };
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![],
            max_recipe_inputs: i32::MAX,
            stocks: vec![BufferedInput::new(Filter::Label("Lava Bucket"), 1)],
        });
        factory.add_process(BufferedConfig {
            name: "bufferG",
            accesses: vec![BusAccess {
            ...
            stocks: vec![
                ...
                BufferedInput::new(Filter::Label("Popped Chorus Fruit"), 64),
                BufferedInput::new(Filter::Label("Enderslime Ball"), 64),
                BufferedInput::new(Filter::Label("Skyslime Ball"), 64),
                BufferedInput::new(Filter::Label("Redstone Dust"), 64),
                BufferedInput::new(Filter::Label("Milk Bottle"), 16),
                BufferedInput::new(Filter::Label("Lava Bucket"), 1),
                BufferedInput::new(Filter::Label("Menril Log"), 64),
                BufferedInput::new(Filter::Label("Blaze Cake"), 64),
                BufferedInput::new(Filter::Label("Charcoal"), 64),
            ],
        });
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![BufferedRecipe {
                ...
                inputs: vec![BufferedInput::new(Filter::Label("Coal Coke Dust"), 8)],
                max_inputs: 32,
            }],
            max_recipe_inputs: i32::MAX,
            stocks: vec![
                BufferedInput::new(Filter::Label("Dry Ice"), 64),
                BufferedInput::new(Filter::Label("Coal Coke"), 64),
                BufferedInput::new(Filter::Label("Uraninite"), 64),
                BufferedInput::new(Filter::Label("Redstone Dust"), 64),
                BufferedInput::new(Filter::Label("Biodiesel Bucket"), 1),
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Infused Alloy"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Enriched Redstone"), vec![(0, 1)]),
                        SlottedInput::new(Filter::Label("Energized Steel"), vec![(1, 8)]),
                    ],
                    max_sets: 1,
                },
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Enriched Diamond"), vec![(0, 1)]),
                        SlottedInput::new(Filter::Label("Obsidian Dust"), vec![(1, 8)]),
                    ],
                    max_sets: 1,
                },
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Enriched Obsidian"), vec![(0, 2)]),
                        SlottedInput::new(Filter::Label("Osmium Ingot"), vec![(1, 1)]),
                    ],
                    max_sets: 1,
                },
            ],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Enriched Redstone"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Redstone Dust"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Enriched Diamond"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Diamond"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Enriched Obsidian"), n_wanted: 16 }],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![BufferedRecipe {
                ...
                inputs: vec![
                    BufferedInput::new(Filter::Label("Iron Plate"), 2),
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Fluorite Dust"), n_wanted: 16 }],
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Obsidian Dust"), n_wanted: 16 }],
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![BufferedInput::new(Filter::Label("Mystical Red Petal"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Dimensional Shard"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Dimensional Shard Chunk"), 1)],
                    max_inputs: i32::MAX,
                },
            ],
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Leaded Concrete"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Lead Plate"), vec![(0, 1)]),
                        SlottedInput::new(Filter::Label("Concrete"), vec![(1, 1)]),
                    ],
                    max_sets: 16,
                },
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Magma Cream"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Blaze Powder"), vec![(0, 1)]),
                        SlottedInput::new(Filter::Label("Slimeball"), vec![(1, 1)]),
                    ],
                    max_sets: 16,
                },
                SlottedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Packed Ice"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Ice"), 16)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("HOP Graphite Ingot"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("HOP Graphite Dust"), 16)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Popped Chorus Fruit"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Chorus Fruit"), 16)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Mystical Red Petal"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Mystical Red Flower"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(RedstoneEmitterConfig {
            accesses: vec![RedstoneAccess { client: "1a", addr: None, side: LEFT, bit: None }],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output {
                        item: Filter::Label("block.resourcefulbees.blaze_honeycomb_block"),
                        n_wanted: 16,
                    }],
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Magma Bricks"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Magma Block"), 4)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Magma Block"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Magma Cream"), 4)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Block of Dimensional Shard"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Dimensional Shard"), 9)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Lava Bucket"), n_wanted: 1 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Bucket"), 1)],
                    max_inputs: 1,
                },
            ],
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Basic Control Circuit"), n_wanted: 4 }],
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            recipes: vec![SlottedRecipe {
                outputs: vec![Output { item: Filter::Label("Biodiesel Bucket"), n_wanted: 1 }],
                inputs: vec![SlottedInput::new(Filter::Label("Bucket"), vec![(0, 1)])],
                max_sets: 1,
            }],
        });
        factory.add_process(MultiInvSlottedConfig {
            ...
            recipes: vec![
                MultiInvSlottedRecipe {
                    outputs: vec![Output { item: luck_cleaver(true), n_wanted: 1 }],
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Andesite Cobblestone"), vec![(9, 0, 1)]),
                        MultiInvSlottedInput::new(luck_cleaver(false), vec![(0, 0, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Rose Gold Repair Kit"), vec![(1, 0, 1)]),
                    ],
                    max_sets: 1,
                },
                MultiInvSlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        MultiInvSlottedInput::new(
                            Filter::Label("Iron Plate"),
                            vec![(0, 0, 1), (2, 0, 1), (6, 0, 1), (8, 0, 1)],
                        ),
                        MultiInvSlottedInput::new(
                            Filter::Label("Glass Pane"),
                ...
                MultiInvSlottedRecipe {
                    ...
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Andesite Cobblestone"), vec![(9, 0, 1)]),
                        MultiInvSlottedInput::new(
                            Filter::Label("Electrum Ingot"),
                            vec![(1, 0, 1), (4, 0, 1), (7, 0, 1)],
                        ),
                        MultiInvSlottedInput::new(
                            Filter::Label("Terracotta"),
                            vec![(3, 0, 1), (5, 0, 1), (6, 0, 1), (8, 0, 1)],
                ...
                MultiInvSlottedRecipe {
                    ...
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Andesite Cobblestone"), vec![(9, 0, 1)]),
                        MultiInvSlottedInput::new(
                            Filter::Label("Gray Rockwool"),
                            vec![(3, 0, 1), (4, 0, 1), (5, 0, 1)],
                        ),
                        MultiInvSlottedInput::new(
                ...
                MultiInvSlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Magebloom Fiber"), n_wanted: 16 }],
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Andesite Cobblestone"), vec![(9, 0, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Magebloom"), vec![(4, 0, 1)]),
                        MultiInvSlottedInput::new(
                            Filter::Label("Silk Fiber"),
                            vec![
                                (0, 0, 1),
                                (1, 0, 1),
                                (2, 0, 1),
                ...
                MultiInvSlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Pity Machine Frame"), n_wanted: 16 }],
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Andesite Cobblestone"), vec![(9, 0, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Leaded Concrete"), vec![(3, 0, 1), (5, 0, 1)]),
                        MultiInvSlottedInput::new(
                            Filter::Label("Iron Mechanical Component"),
                            vec![(1, 0, 1), (7, 0, 1)],
                        ),
                        MultiInvSlottedInput::new(
                            Filter::Label("Andesite Casing"),
                            vec![(0, 0, 1), (2, 0, 1), (6, 0, 1), (8, 0, 1)],
                        ),
                        MultiInvSlottedInput::new(Filter::Name("thermal:machine_frame"), vec![(4, 0, 1)]),
                    ],
                    max_sets: 1,
                },
            ],
        ...
        factory.add_process(ScatteringConfig {
            ...
            recipes: vec![
                ...
                ScatteringRecipe::new(
                    vec![
                        Output { item: Filter::Label("Ender Pearl"), n_wanted: 16 },
                        Output { item: Filter::Label("Dimensional Shard Chunk"), n_wanted: 16 },
                    ],
        ...
        factory.add_process(MultiInvSlottedConfig {
            ...
            recipes: vec![
                ...
                MultiInvSlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Rune of Fire"), n_wanted: 16 }],
                    inputs: vec![
                        MultiInvSlottedInput::new(Filter::Label("Livingrock"), vec![(0, 0, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Mana Powder"), vec![(1, 0, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Manasteel Ingot"), vec![(1, 1, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Blaze Powder"), vec![(1, 2, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Magma Bricks"), vec![(1, 3, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("Ditchbulb"), vec![(1, 4, 1)]),
                        MultiInvSlottedInput::new(Filter::Label("White Candle"), vec![(1, 5, 1)]),
                    ],
                    max_sets: 1,
                },
            ],
            ...
            recipes: vec![
                ...
                MultiInvSlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        MultiInvSlottedInput::new(
                            Filter::Label("Flux Dust"),
                            vec![(5, 0, 1), (6, 0, 1), (7, 0, 1), (8, 0, 1)],
                        ),
                ...
                MultiInvSlottedRecipe {
                    ...
                    inputs: vec![
                        MultiInvSlottedInput::new(
                            Filter::Name("emendatusenigmatica:arcane_gem"),
                            vec![(1, 0, 1), (2, 0, 1), (3, 0, 1), (4, 0, 1)],
                        ),
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                ...
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Blue Ice"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Packed Ice"), 1)],
                    max_inputs: i32::MAX,
                },
            ],
            max_recipe_inputs: 8,
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Dry Ice"), n_wanted: 16 }],
                    inputs: vec![SlottedInput::new(Filter::Label("Blue Ice"), vec![(1, 1), (2, 1)])],
                    max_sets: 1,
                },
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Uraninite"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Sulfur Dust"), vec![(1, 1)]),
                        SlottedInput::new(Filter::Label("Uranium Ingot"), vec![(2, 1), (3, 1)]),
                        SlottedInput::new(Filter::Label("Fluorite Dust"), vec![(4, 1)]),
                    ],
                    max_sets: 1,
                },
                SlottedRecipe {
                ...
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Blazing Crystal"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Blaze Fiber"), vec![(1, 1)]),
                        SlottedInput::new(Filter::Label("item.resourcefulbees.blaze_honeycomb"), vec![(2, 1)]),
                    ],
                    max_sets: 1,
                },
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("Infused Enderpearl"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Block of Crystalized Chorus"), vec![(1, 1)]),
                        SlottedInput::new(Filter::Label("Block of Dimensional Shard"), vec![(2, 1)]),
                        SlottedInput::new(Filter::Label("Ender Pearl"), vec![(3, 1)]),
                    ],
                    max_sets: 1,
                },
                SlottedRecipe {
                    ...
                    inputs: vec![
                        SlottedInput::new(Filter::Label("Block of Crystalized Menril"), vec![(1, 1)]),
                        SlottedInput::new(Filter::Label("Block of Dimensional Shard"), vec![(2, 1)]),
                        SlottedInput::new(Filter::Label("Diamond"), vec![(3, 1)]),
                    ],
                    max_sets: 1,
                },
            ],
        ...
        factory.add_process(BufferedConfig {
            ...
            recipes: vec![
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Menril Log"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Menril Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![
                        Output { item: Filter::Label("Flourishing Archwood Leaves"), n_wanted: 16 },
                        Output { item: Filter::Label("Flourishing Archwood Log"), n_wanted: 16 },
                        Output { item: Filter::Label("Apple"), n_wanted: 16 },
                    ],
                    inputs: vec![BufferedInput::new(Filter::Label("Flourishing Archwood Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Industrial Hemp Fiber"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Industrial Hemp Seeds"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Chorus Fruit"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Chorus Flower"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Enderslime Ball"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Enderslime Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Skyslime Ball"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Skyroot Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Plum"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Plum Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Mango"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Mango Sapling"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Wheat"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Wheat Seeds"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Ginger"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Ginger Seeds"), 1)],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Grass"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Grass"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![BufferedInput::new(Filter::Label("Cumin Seeds"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Rice Panicle"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Rice"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Mystical Black Flower"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Mystical Black Flower"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Mystical Green Flower"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Mystical Green Flower"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Mystical Red Flower"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Mystical Red Flower"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Ditchbulb"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Ditchbulb"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                ...
                BufferedRecipe {
                    ...
                    inputs: vec![BufferedInput::new(Filter::Label("Sugar Cane"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
                BufferedRecipe {
                    outputs: vec![Output { item: Filter::Label("Kelp"), n_wanted: 16 }],
                    inputs: vec![BufferedInput::new(Filter::Label("Kelp"), 1).allow_backup()],
                    max_inputs: i32::MAX,
                },
            ],
            max_recipe_inputs: 8,
            stocks: vec![BufferedInput::new(Filter::Label("Phyto-Gro"), 64)],
        });
        factory.add_process(BufferedConfig {
            name: "airCharger",
            accesses: vec![BusAccess {
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    outputs: vec![Output { item: Filter::Label("White Candle"), n_wanted: 16 }],
                    inputs: vec![
                        SlottedInput::new(Filter::Label("White Dye"), vec![(0, 1)]),
                        SlottedInput::new(Filter::Label("Beeswax"), vec![(1, 1)]),
                        SlottedInput::new(Filter::Label("String"), vec![(2, 1)]),
                    ],
                    max_sets: 8,
                },
            ],
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            recipes: vec![SlottedRecipe {
                outputs: vec![Output { item: Filter::Label("Rose Gold Repair Kit"), n_wanted: 16 }],
                inputs: vec![SlottedInput::new(Filter::Label("Rose Gold Ingot"), vec![(0, 2)])],
                max_sets: 8,
            }],
        });
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            recipes: vec![SlottedRecipe {
                outputs: vec![Output { item: Filter::Label("Blaze Fiber"), n_wanted: 16 }],
                inputs: vec![
                    SlottedInput::new(Filter::Label("Magebloom Fiber"), vec![(0, 2)]),
                    SlottedInput::new(Filter::Label("Ditchbulb"), vec![(1, 1)]),
                ],
                max_sets: 8,
            }],
        });
        factory.add_process(SlottedConfig {
            name: "lithiumDissolution",
            accesses: vec![BusAccess {
                client: "1a",
            ...
            to_extract: None,
            recipes: vec![SlottedRecipe {
                outputs: vec![Output { item: Filter::Label("Advanced Control Circuit"), n_wanted: 4 }],
                inputs: vec![
                    SlottedInput::new(Filter::Label("CPU Core B500"), vec![(0, 1)]),
                    SlottedInput::new(Filter::Label("Infused Alloy"), vec![(1, 2)]),
                    SlottedInput::new(Filter::Label("Basic Control Circuit"), vec![(2, 1)]),
                    SlottedInput::new(Filter::Label("item.kubejs.memory_advanced_filled"), vec![(3, 1)]),
                ],
                max_sets: 1,
            }],
        })
